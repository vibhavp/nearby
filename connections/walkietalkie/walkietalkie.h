...
class WalkieTalkie {
 ...
 public:
  ...
  void start() {
    ...
    advertising.allowed.wifi_direct = true;
    advertising.allowed.ble = true;
    advertising.low_power = true;
    advertising.auto_upgrade_bandwidth = true;    
    ...
    discovery.low_power = discovery.low_power;
    ...
    discovery_listener.endpoint_found_cb =
        [this, local_endpoint_info](const std::string& remote_endpoint_id,
          ...
          conn_options.allowed.wifi_hotspot = true;
	  conn_options.auto_upgrade_bandwidth = true;
    ...
    //     discovery_listener, [](nearby::connections::Status status) {
